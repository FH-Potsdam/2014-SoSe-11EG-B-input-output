...
void setup() {
  ...
  table = loadTable("Rec 06-All-Data.tsv", "header, tsv");
  //table = loadTable("Rec 05-All-Data.tsv", "header, tsv");
  //table = loadTable("Rec 04-All-Data.tsv", "header, tsv");
  //table = loadTable("Rec 03-All-Data.tsv", "header, tsv");
  //table = loadTable("Rec 02-All-Data.tsv", "header, tsv");
